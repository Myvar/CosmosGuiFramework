...
namespace Cosmos.System.Plugs.System
{
    ...
    public static class NumberImpl
    {
        ...
        public static string FormatSingle(float aValue, string aStr, NumberFormatInfo aFormat)
        {
            return "fix me in Cosmos.IL2CPU.IL.CustomImplementations.System.NumberImpl.FormatSingle"; 
        }
    }
}